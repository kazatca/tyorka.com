...
export default () => (
  <>
    ...
    <p>
      At {domain}, accessible from https://{domain}, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by {domain} and how we
      use it.
    </p>
    ...
    <p>
      ...
      and/or collect in {domain}. This policy is not applicable to any
    ...
    <p>
      {domain} follows a standard procedure of using log files. These files log
    ...
    <p>
      ...
      advertising partners of {domain}.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on {domain}, which are sent directly
    ...
    <p>
      Note that {domain} has no access to or control over these cookies that are
